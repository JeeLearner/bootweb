...
(function ($) {
    $.extend({
                ...
                $.modal.confirm("确定导出所有" + table.options.modalName + "吗？", function() {
                    ...
                    $.post(table.options.exportUrl, dataParam, function(result) {
                        if (result.code == web_status.SUCCESS) {
                            window.location.href = ctx + "common/download?fileName=" + encodeURI(result.data.filename) + "&delete=" + true;
                    ...
                    btn1: function(index, layero){
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                if (result.code == web_status.SUCCESS) {
                                    $.modal.closeAll();
                                    $.modal.alertSuccess(result.data.info);
                                    $.table.refresh();
                                } else if (result.code == web_status.WARNING) {
                                    layer.close(index);
                                    $.modal.enable();
        ...
        operate: {
            ...
            // put请求传输
            clearCache: function(url, callback) {
