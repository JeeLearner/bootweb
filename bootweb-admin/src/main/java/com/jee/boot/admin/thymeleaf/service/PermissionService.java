...
public class PermissionService {
    ...
    public String hasPermi(String permission){
        return isPermitted(permission) ? JeeStringUtils.EMPTY : NOACCESS;
    }
    ...
    public String lacksPermi(String permission){
        return isLacksPermitted(permission) ? JeeStringUtils.EMPTY : NOACCESS;
    }
    ...
    public String hasAnyPermi(String permissions){
        return hasAnyPermissions(permissions, PERMISSION_DELIMETER) ? JeeStringUtils.EMPTY : NOACCESS;
    }
    ...
    public String hasRole(String role){
        return isRole(role) ? JeeStringUtils.EMPTY : NOACCESS;
    }
    ...
    public String lacksRole(String role){
        return isLacksRole(role) ? JeeStringUtils.EMPTY : NOACCESS;
    }
    ...
    public String hasAnyRoles(String roles) {
        return isAnyRoles(roles, ROLE_DELIMETER) ? JeeStringUtils.EMPTY : NOACCESS;
    }
