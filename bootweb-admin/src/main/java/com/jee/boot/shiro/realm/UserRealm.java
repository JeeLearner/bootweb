package com.jee.boot.shiro.realm;

import com.jee.boot.shiro.service.SysLoginService;
...
public class UserRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        if (user.isAdmin()){
            ...
            roles = roleService.listRoleKeys(user.getUserId());
            menus = menuService.listPermsByUserId(user.getUserId());
