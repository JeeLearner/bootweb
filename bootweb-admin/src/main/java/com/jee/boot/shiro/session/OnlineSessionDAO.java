package com.jee.boot.shiro.session;

import com.jee.boot.shiro.manager.factory.ShiroAsyncFactory;
import com.jee.boot.shiro.service.SysShiroService;
...
public class OnlineSessionDAO extends EnterpriseCacheSessionDAO {
    ...
    public void syncToDb(OnlineSession onlineSession){
        ...
        AsyncManager.me().execute(ShiroAsyncFactory.syncSessionToDb(onlineSession));
    }
}
