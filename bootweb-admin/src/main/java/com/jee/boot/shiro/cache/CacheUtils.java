package com.jee.boot.shiro.cache;
...
public class CacheUtils {
    ...
    public static Object get(String key){
        return get(CacheConstant.SYS_CACHE, key);
    }
    ...
    public static void put(String key, Object value){
        put(CacheConstant.SYS_CACHE, key, value);
    }
    ...
    public static void remove(String key) {
        remove(CacheConstant.SYS_CACHE, key);
    }
    ...
    public static void removeByKeys(Set<String> keys){
        removeByKeys(CacheConstant.SYS_CACHE, keys);
    }
