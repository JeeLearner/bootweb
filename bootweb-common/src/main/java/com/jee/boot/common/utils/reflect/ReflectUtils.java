package com.jee.boot.common.utils.reflect;
...
public class ReflectUtils {
    ...
    public static <E> E invokeGetter(Object obj, String propertyName){
        Object object = obj;
        for (String name : JeeStringUtils.split(propertyName, ".")){
            String getterMethodName = GETTER_PREFIX + JeeStringUtils.capitalize(name);
    ...
    public static <E> void invokeSetter(Object obj, String propertyName, E value) {
        Object object = obj;
        String[] names = JeeStringUtils.split(propertyName, ".");
        for (int i = 0; i < names.length; i++) {
            if (i < names.length - 1)
            {
                String getterMethodName = GETTER_PREFIX + JeeStringUtils.capitalize(names[i]);
                object = invokeMethod(object, getterMethodName, new Class[] {}, new Object[] {});
            } else {
                String setterMethodName = SETTER_PREFIX + JeeStringUtils.capitalize(names[i]);
            ...
            for (int i = 0; i < cs.length; i++) {
                if (args[i] != null && !args[i].getClass().equals(cs[i])) {
                    if (cs[i] == String.class) {
                        ...
                        if (JeeStringUtils.endsWith((String) args[i], ".0")){
                            args[i] = JeeStringUtils.substringBefore((String) args[i], ".0");
                        }
                        ...
                        if (args[i] instanceof String) {
                            args[i] = DateUtils.autoParseDateTime(args[i]);
                        } else if (args[i] instanceof Double) {
                            args[i] = DateUtil.getJavaDate((Double) args[i]);
                        } else if (args[i] instanceof Date) {
                            //Date -> LocalDateTime
                            args[i] = DateUtils.format((Date) args[i]);
                        } else {
