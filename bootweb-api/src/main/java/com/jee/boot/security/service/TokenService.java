...
import com.jee.boot.common.utils.IdUtils;
import com.jee.boot.common.utils.IpUtils;
import com.jee.boot.common.utils.WebUtils;
...
public class TokenService {
    ...
    private static final Long MILLIS_MINUTE_20 = 20 * MILLIS_MINUTE;
    ...
    public LoginUser getLoginUser(HttpServletRequest request) {
        ...
        if (JeeStringUtils.isNotEmpty(token)){
    ...
    public void setLoginUser(LoginUser loginUser) {
        if (JeeStringUtils.isNotNull(loginUser) && JeeStringUtils.isNotEmpty(loginUser.getToken())) {
    ...
    private void setUserAgent(LoginUser loginUser) {
        UserAgent userAgent = WebUtils.getUserAgent(ServletUtils.getRequest());
    ...
    private String getToken(HttpServletRequest request) {
        ...
        if (JeeStringUtils.isNotEmpty(token) && token.startsWith(TokenConstants.TOKEN_PREFIX)){
    ...
    public static void main(String[] args) {
        ...
        // 解析对应的权限以及用户信息
        String uuid = (String) claims.get(TokenConstants.LOGIN_USER_KEY);
        System.out.println("uuid(token):" + uuid);
        String userKey = RedisConstants.LOGIN_TOKEN_KEY + uuid;
